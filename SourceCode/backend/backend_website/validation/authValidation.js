...
const registerValidation = (data) => {
    var now = new Date();
    var min = new Date(now.getFullYear()-120 + 1, now.getMonth(), now.getDate());
...
module.exports.resetPasswordMobileVersionValidation = resetPasswordMobileVersionValidation;
