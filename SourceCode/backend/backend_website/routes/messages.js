...
router.get('/messengerId=:messengerId&pageSize=:pageSize&currentPage=:currentPage', verify, async (req, res) => {

    try {
        const data = await Message.getMessages(req.params.messengerId, req.params.pageSize, req.params.currentPage);
