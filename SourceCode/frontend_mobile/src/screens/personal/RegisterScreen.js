...
class RegisterScreen extends Component {
  ...
  checkValidate = (name, value) => {
    switch (name) {
      case 'email':
        value.error =
          value.value.length > 0
            ? isValidLength(value.value, 5, 255).error
            : 'Chưa nhập';
      ...
      case 'password':
        value.error =
          value.value.length > 0
            ? isValidLength(value.value, 6, 255).error
            : 'Chưa nhập';
        break;
      case 'rePassword':
        value.error =
          value.value.length > 0
            ? value.value === this.state.password.value
              ? ''
      ...
      case 'name':
        value.error =
          value.value.length > 0
            ? isValidLength(value.value, 6, 500).error
            : 'Chưa nhập';
        break;
      case 'phoneNumber':
        value.error = isPhoneNumber(value.value)
          ? ''
      ...
      case 'streetOrBuilding':
        value.error =
          value.value.length > 0
            ? isValidLength(value.value, 5, 500).error
            : 'Chưa nhập';
        break;
      case 'birthday':
  ...
  onSubmit = () => {
    ...
    if (districts) {
      ...
      let wards = districts
        .filter(district => Number(district.id) === Number(districtId.value))
  ...
  onChange = (name, value) => {
    ...
    if (name === 'cityId') this.props.fetchDistricts(value.value);
    this.setState({
      [name]: value,
    });
  };
      ...
      optionDistricts = districts.map((district, index) => {
        return (
          <Picker.Item
            ...
            index={index}
            value={district.id}
            label={district.name}></Picker.Item>
        );
      });
      let wards = districts
        .filter(
          district =>
            Number(district.id) === Number(this.state.districtId.value),
        )
        .map(district => district.wards);
      if (wards.length > 0)
      ...
      <ScrollView style={{width: '100%'}}>
        <Background>
          ...
          <TextInput
            ...
            onChangeText={text =>
              this.onChange('name', {value: text, error: ''})
            }
          ...
          <TextInput
            ...
            onChangeText={text =>
              this.onChange('phoneNumber', {value: text, error: ''})
            }
          ...
          <TextInput
            ...
            onChangeText={text =>
              this.onChange('rePassword', {value: text, error: ''})
            }
          ...
          <View style={styles.row}>
            ...
            <View style={{width: '65%'}}>
              <DateInput
                ...
                onChange={date =>
                  this.onChange('birthday', {value: date, error: ''})
                }
              ...
              <View style={styles.row}>
                <View style={styles.col_50_male}>
                  <RadioButton
                    ...
                    onPress={() =>
                      this.onChange('male', {value: true, error: ''})
                    }
                  />
                ...
                <View style={styles.col_50_male}>
                  <RadioButton
                    ...
                    status={!this.state.male.value ? 'checked' : 'unchecked'}
                    onPress={() =>
                      this.onChange('male', {value: false, error: ''})
                    }
                  />
          ...
          <View style={styles.row}>
            <View style={styles.col_35}>
              <Text style={{textAlign: 'center'}}>Tỉnh:</Text>
            </View>
            <View style={{width: '65%'}}>
              <MyPicker
                label="cityId"
                ...
                onValueChange={(itemValue, itemIndex) =>
                  this.onChange('cityId', {value: itemValue, error: ''})
                }
          ...
          <View style={styles.row}>
            <View style={styles.col_35}>
              <Text style={{textAlign: 'center'}}>Quận/Huyện:</Text>
            </View>
            <View style={{width: '65%'}}>
              <MyPicker
                label="districtId"
                ...
                onValueChange={(itemValue, itemIndex) =>
                  this.onChange('districtId', {value: itemValue, error: ''})
                }
          ...
          <View style={styles.row}>
            <View style={styles.col_35}>
              <Text style={{textAlign: 'center'}}>Phường/Xã:</Text>
            </View>
            <View style={{width: '65%'}}>
              <MyPicker
                label="wardId"
                ...
                onValueChange={(itemValue, itemIndex) =>
                  this.onChange('wardId', {value: itemValue, error: ''})
                }
          ...
          <TextInput
            ...
            onChangeText={text =>
              this.onChange('streetOrBuilding', {value: text, error: ''})
            }
