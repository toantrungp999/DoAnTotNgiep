      ...
      <ScrollView style={{width: '100%'}}>
        <View
          ...
          <View style={styles.row}>
            <Text style={{fontSize: 24, fontWeight: 'bold', paddingBottom: 5}}>
              Menu
            </Text>
          </View>
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              style={{width: 24, height: 24, borderWidth: 1, borderRadius: 12}}
            />
            <Text style={styles.textRow}>{name}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.push('orderStackScreen', {
                screen: 'orderScreen',
              });
            }}
            style={styles.row}>
          ...
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.push('ChangePhoneNumberScreen');
            }}
            style={styles.row}>
          ...
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.push('ChangePasswordSreen');
            }}
            style={styles.row}>
