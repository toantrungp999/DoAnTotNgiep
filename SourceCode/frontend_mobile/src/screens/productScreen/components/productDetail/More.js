      ...
      <View style={styles.container}>
        <View style={styles.row}>
          <Button
            ...
            style={index === 0 ? styles.chooseBtn : styles.btn}
            labelStyle={index === 0 ? styles.chooseBtnText : styles.btnText}>
            Mô tả
          </Button>
          <Button
            onPress={() => this.setState({index: 1})}
            style={index === 1 ? styles.chooseBtn : styles.btn}
            labelStyle={index === 1 ? styles.chooseBtnText : styles.btnText}>
            Bình luận
          </Button>
          <Button
            onPress={() => this.setState({index: 2})}
            style={index === 2 ? styles.chooseBtn : styles.btn}
            labelStyle={index === 2 ? styles.chooseBtnText : styles.btnText}>
            Đánh giá
          </Button>
        </View>
        <View style={styles.row}>
          <View style={{marginLeft: 10}}>
            ...
            {index === 1 && (
              <Comments
                ...
                viewMoreComments={this.props.viewMoreComments}
                lengthCmt={this.props.lengthCmt}
                totalCmt={this.props.totalCmt}
            ...
            {index === 2 && (
              <Rates
                viewMoreRates={this.props.viewMoreRates}
                lengthRate={this.props.lengthRate}
                totalRate={this.props.totalRate}
                onCreateRate={this.props.onCreateRate}
                onCreateReply={this.props.onCreateRateReply}
