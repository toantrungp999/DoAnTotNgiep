...
class ChangeItemCart extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      productOptionsReducer.quantityLoading === false &&
      productOptionsReducer !== prevProps.productOptionsReducer &&
      !this.state.quantityOption
    ) {
      let {quantityOptions} = productOptionsReducer;
      if (
        this.state.isUpdateType === false &&
        quantityOptions &&
      ...
      <Modal
        ...
        <View style={styles.bottomView}>
          <View style={styles.containerMain}>
              ...
              <View style={{width: '62%', marginTop: 10, marginLeft: 10}}>
                <View style={styles.row}>
                  ...
                  <Text style={styles.salePrice}>
                    {convertNumberToVND(this.state.quantity * this.props.price)}{' '}
                    ₫
                  </Text>
                </View>
                <View style={styles.row}>
                  <Text style={styles.text}>
                    Số lượng trong kho: {this.state.quantityOption.quantity}
                  </Text>
                </View>
              </View>
            ...
            <TouchableOpacity
              onPress={this.onUpdateType}
              style={styles.agreebtn}>
              <Text style={styles.textAgree}>Đồng ý</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
