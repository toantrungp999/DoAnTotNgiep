  ...
  render() {
    ...
    let elementCarts = carts
      ? carts.map((cart, index) => {
          ...
          let {size} = sizeId;
          total += selectedList.includes(cart._id)
    ...
    return (
      <View style={styles.containerMain}>
        <ScrollView
          style={
            this.state.isVisible
              ? {backgroundColor: '#999999', width: '100%'}
          ...
          <View style={{padding: 0}}>{elementCarts}</View>
        </ScrollView>
        <View style={styles.bottomView}>
          ...
          <TouchableOpacity style={styles.btnBuy} onPress={this.onBuy}>
