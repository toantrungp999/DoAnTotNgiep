...
class RecommendedSection extends Component {
    render() {
        ...
        let productElements = products ? products.map((product, index) => {
        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={styles.content} horizontal={true} showsHorizontalScrollIndicator={false}>
                    {productElements}
                </ScrollView>
            </View>
        )
