      ...
      ? orderDetails.map((orderDetail, index) => {
          return (
            <OrderDetailItem
              ...
              end={index === orderDetails.length - 1}
            />
          );
        })
      : null;
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.mainContainer}>
          ...
          <View style={styles.orderContainer}>
            ...
            <View>{OrderDetailItems}</View>
            <View style={styles.bottom}>
              <Text style={styles.fee}>
                Tổng tiền hàng: {convertNumberToVND(orderInfo.totalPrice)}₫
              </Text>
              {orderInfo.shippingFee !== 0 ? (
                <Text style={styles.fee}>
                  Phí vận chuyển: {convertNumberToVND(orderInfo.shippingFee)}₫
                </Text>
              ) : null}
          ...
          {orderInfo.shipBrand !== '' ? (
            <View style={styles.shipContainer}>
              ...
              <Text style={styles.info}>
                Mã vận đơn: {orderInfo.shipOrderId}
              </Text>
              <Text style={styles.info}>
                Ngày nhận dự kiến:{' '}
                {getStringDate(orderInfo.expectedReceiveDate)}
              </Text>
            </View>
          ) : null}
          {orderInfo.paymentType ===
            OrderTypes.ONLINE_ORDER.PAYMENT_TYPE.VNPAY &&
          ...
          orderInfo.paymentId ? (
            <View style={styles.shipContainer}>
              ...
              <Text style={styles.info}>
                Mã giao dịch: {orderInfo.paymentId}
              </Text>
            </View>
          ) : null}
        </ScrollView>
