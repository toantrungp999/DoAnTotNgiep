      ...
      <Portal>
        <Modal
          ...
          <RadioButton.Group
            ...
            <TouchableOpacity
              onPress={() => {
                this.changeReason(CancelReasons.CONFUSION);
              }}>
              <View style={styles.radioItem}>
                <RadioButton value={CancelReasons.CONFUSION} />
                <Text style={styles.text}>{CancelReasons.CONFUSION}</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
                this.changeReason(CancelReasons.NO_MORE_BUYING);
              }}>
              <View style={styles.radioItem}>
                <RadioButton value={CancelReasons.NO_MORE_BUYING} />
                <Text style={styles.text}>{CancelReasons.NO_MORE_BUYING}</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
                this.changeReason(CancelReasons.OTHER);
              }}>
              <View style={styles.radioItem}>
                <RadioButton value={CancelReasons.OTHER} />
          ...
          <View style={styles.buttonContainer}>
            <Button
              ...
              contentStyle={styles.buttonContain}
              onPress={() => {
                hideCancelModal();
              }}>
              Trở lại
