  ...
  render() {
    ...
    statusBar.push(
      <TouchableOpacity
        ...
        style={[
          styles.item,
          currentStatus === 'Tất cả' ? styles.itemSelect : null,
        ]}
        onPress={() => {
          this.props.changeStatus('Tất cả');
        }}>
        <Text
          style={[
            styles.text,
            currentStatus === 'Tất cả' ? styles.textSelect : null,
          ]}>
          Tất cả
        </Text>
      </TouchableOpacity>,
    ...
    for (const [index, value] of Object.entries(OrderStatuses)) {
      ...
      statusBar.push(
        <TouchableOpacity
          ...
          style={[
            styles.item,
            currentStatus === value ? styles.itemSelect : null,
          ]}
          onPress={() => {
          ...
          <Text
            style={[
              styles.text,
              currentStatus === value ? styles.textSelect : null,
            ]}>
            {dislayValue}
          </Text>
        </TouchableOpacity>,
