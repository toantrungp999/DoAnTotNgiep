...
import {
  fectchProductHomepagesRequest,fectchRecommendedProductsRequest
      ...
      return (
        <div className='home-page'>
          ...
          <div className="home-page-section">
            ...
            <ProductSection products={news} sizeOptions={sizeOptions} colorOptions={colorOptions} title='Mới nhất' description='Xu hướng thời trang dành cho bạn' path='new-product' />
            <MiddlePanel index = {1}/>
            <ProductSection products={hots} sizeOptions={sizeOptions} colorOptions={colorOptions} title='Nổi bật' description='Sản phẩm yêu thích của giới trẻ' path='hot-produtc'/>
            <MiddlePanel index = {0}/>
            <MiddlePanel index = {2}/>
            <ProductSection products={bestSellers} sizeOptions={sizeOptions} colorOptions={colorOptions} title='Bán chạy' description='Sản phẩm được mua nhiều nhất' path='best-seller'/>
