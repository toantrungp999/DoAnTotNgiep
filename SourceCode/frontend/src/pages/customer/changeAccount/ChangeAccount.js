...
class ChangeAccount extends Component {
    ...
    render() {
        ...
        let element = <Loading />;
        var feature = this.props.match.params.feature !== undefined ? this.props.match.params.feature : 'profile';
        const { loading, message } = userProfileReducer;
        if (!loading && !message) {//kiem tra lay api co loi hay ko 
...
export default connect(mapStateToProps, mapDispatchToProps)(memo(ChangeAccount));