  ...
  render() {
    return (
      <nav className="navbar navbar-expand-sm navbar-dark bg-dark header-admin">
        <Link className="navbar-brand pl-4" to="/"><i className="fas fa-home pr-1"></i>Trang chủ</Link>
        ...
        <div className="collapse navbar-collapse" id="collapsibleNavId">
          <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li className="nav-item">
              <Notifacations onViewNotification={this.onViewNotification} viewNotification={this.state.viewNotification} clearNotify={this.props.clearNotify} notificationsReducer={this.props.notificationsReducer} fectchNotifications={this.props.fectchNotifications} updateNotification={this.props.updateNotification} />
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/" onClick={this.logout}>Đăng xuất</Link>
            </li>
          </ul>
        </div>
      </nav>
