    ...
    render() {
        ...
        this.state.nodes.forEach((item, index) => {
            if (item.id.toString() === this.state.currentNode.toString()) {
                nodes.push(<div className='active' onClick={this.onChangePoster} key={item.id} id={item.id}></div>);
                images.push(<Link key={item.id} to={item.path} className='active'>
                ...
                nodes.push(<div className='' onClick={this.onChangePoster} key={item.id} id={item.id}></div>);
                images.push(<Link key={item.id} to={item.path} >
