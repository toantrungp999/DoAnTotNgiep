  ...
  render() {
                ...
                <div key={notification._id} index={index}>
                  ...
                  >
                    <div className="row" style={{ marginBottom: "5px" }}>
                      ...
                      <div className="col-9">
                        <div className="row">
                          <div className="content-user-notification">
                            <strong>{action.name}</strong>
                            {action.content}
                          </div>
                        </div>
                        <div className="row time-notification">
    ...
    return (
      <>
        <Link
          to="#"
          className="nav-link user-notifications"
        ...
        >
          <i className="icon fab fa fa-bell"></i>
          {count !== 0 ? (
        ...
        {this.props.viewNotification ? (
          <div className="activity-user-notification">
            <h4>Thông báo</h4>
            {this.props.role !== "customer" && this.props.role !== "none" ? (
              <div
                style={{
