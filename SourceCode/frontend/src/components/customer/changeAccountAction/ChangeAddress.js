...
class ChangeAddress extends Component {
    ...
    render() {
        ...
        if (loading)
            ...
            const adressItems = addresses ? addresses.map((address, index) => {
                return <AddressItem
            ...
            return (
                <div className='change-address-page'>
                    {this.state.dialogAddressShow ?
                        <DialogActionsAddress onClose={this.hideModal}
                    ...
                    <div className="header">
                        ...
                        <div className="description">Địa chỉ được sử dụng để đặt và giao hàng</div>
                    </div>
                    <div className="">
                        <button className='btn-add' type="button" onClick={this.addAddress}><PlusCircleOutlined /> Thêm địa chỉ</button>
                    </div>
                    <div className='body'>
                        {adressItems}
                    </div>
