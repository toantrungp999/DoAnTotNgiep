                ...
                <div className='middle-panel-section mobile'>
                    <div className='box'>
                        <Link className='panel-1' to='/black-color'>
                            <img alt="black-color" src='https://res.cloudinary.com/websitebandienthoai/image/upload/v1624033994/Poster/MiddlePanel_1_spzsxt.webp' />
                ...
                <div className='middle-panel-section mobile'>
                    <div className='box'>
                        <Link className='panel-2 mobile' to='sale-off'>
                            <img alt="sale-off" src='https://res.cloudinary.com/websitebandienthoai/image/upload/v1624033994/Poster/MiddlePanel_2_p4i4ca.webp' />
