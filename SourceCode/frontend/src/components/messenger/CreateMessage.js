...
import { closeMessage, sendMessageToUser, sendMessageToBot } from '../../actions/messengerActions';
import {
    fectchAllUsersRequest
                ...
                <div className="messenger-box">
                    <div className="row message-title">
                        <div className="col-10">
                            <div style={{ fontWeight: 'bold', marginLeft: '2px' }}>Tin nhắn mới</div>
                        </div>
                    ...
                    <div className="row type-message">
                        <div style={{ width: '87%', marginLeft: '12px' }}>
                            <div className="form-group" style={{ marginBottom: '8px' }}>
                                <input className="form-control" name="content" onKeyPress={this.handleKeyPress} onChange={this.onChange} type="text" placeholder="Nhập nội dung" />
                            </div>
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(memo(CreateMessage));
