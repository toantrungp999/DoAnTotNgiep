...
export default function Toolbar() {
  ...
  const navUpdate = () => {
    ...
    if (sel && sel.rangeCount > 0) {
      ...
      // buscará os pais do nó selecionado recursivamente e Thêmá na lista
    ...
    <div className="row">
      ...
      <Modal triggers={['toolbar-link-button', 'submit-url-link']} >
        <form onSubmit={(e) => linking(e, 'CreateLink')}>
          ...
          <button id='submit-url-link' type='submit' > Thêm </button>
        </form>
      </Modal>
      ...
      <Modal triggers={['toolbar-yt-button', 'submit-yt-link']} >
        <form onSubmit={(e) => addYtLink(e)}>
          ...
          <input type='text' value={url} onChange={(e) => setUrl(e.target.value)} />
          <button id='submit-yt-link' type='submit' > Thêm </button>
        </form>
      </Modal>
      ...
      <Modal triggers={['toolbar-img-button', 'submit-img-link']} >
        <form onSubmit={(e) => linking(e, 'insertImage')}>
          ...
          <input type='text' value={url} onChange={(e) => setUrl(e.target.value)} />
          <button id='submit-img-link' type='submit' > Thêm </button>
        </form>
      </Modal>
