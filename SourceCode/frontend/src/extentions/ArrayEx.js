function findIndexById(array, _id) {
  for (var i = array.length - 1; i >= 0; i--)
    if (array[i]._id && array[i]._id.toString() === _id.toString())
      return i;
    else if (array[i].id && array[i].id.toString() === _id.toString())
      return i;
  return -1;
}
...
export { findIndexById, findIndexByName, convertNumberToVND, time_ago, isNumber, isValidLength, isValidDate, isPhoneNumber, isEmail, formatDate, getStringDate }