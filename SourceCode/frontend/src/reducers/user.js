...
function userInfoReducer(state = initialStateUser, action) {
  switch (action.type) {
    ...
    case Types.USER_SIGNIN_FAIL:
      ...
      // if (message === ServerMessageError.EMAIL_PASSWORD_NOT_CORRECT)
      //   message = Message.EMAIL_PASSWORD_NOT_CORRECT_VN;
      // else if (message === ServerMessageError.ACCOUNT_HAS_BEEN_BLOCK)
      //   message = Message.ACCOUNT_HAS_BEEN_BLOCK_VN;
