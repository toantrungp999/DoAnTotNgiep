...
export const fectchRatesRequest = (productId, lengthRate = 5) => {
  return (dispatch) => {
    ...
    callApi(`rates/${productId}&pagesize=${lengthRate}`, "GET", null).then(
      (response) => {
        const type =
          response.status === 0 ? Types.RATES_SUCCESS : Types.RATES_FAIL;
...
export const createRateRequest = (data, dataUser) => {
  return (dispatch) => {
    ...
    callApiToken(dispatch, "rates", "POST", data).then((response) => {
      ...
      } else type = Types.RATE_CREATE_FAIL;
      dispatch({ type, payload: response });
    });
  };
};
  ...
  return (dispatch) => {
    ...
    callApiToken(dispatch, "rates", "PUT", data).then((response) => {
      ...
      if (response.status === 0) {
        ...
        response.data = data;
      } else type = Types.RATE_UPDATE_FAIL;
      dispatch({ type, payload: response });
    });
  };
};
  ...
  return (dispatch) => {
    ...
    callApiToken(dispatch, "rates", "DELETE", data).then((response) => {
      ...
      if (response.status === 0) {
        ...
        response.data = data;
      } else type = Types.RATE_DELETE_FAIL;
      dispatch({ type, payload: response });
    });
  };
};
...
export const createRateReplyRequest = (data) => {
  return (dispatch) => {
    ...
    callApiToken(dispatch, "rates/replies", "POST", data).then((response) => {
      const type =
        response.status === 0
          ? Types.RATE_REPLY_CREATE_SUCCESS
          : Types.RATE_REPLY_CREATE_FAIL;
      dispatch({ type, payload: response });
    });
  };
};
...
export const updateRateReplyRequest = (data) => {
  return (dispatch) => {
    ...
    callApiToken(dispatch, "rates/replies", "PUT", data).then((response) => {
      const type =
        response.status === 0
          ? Types.RATE_REPLY_UPDATE_SUCCESS
          : Types.RATE_REPLY_UPDATE_FAIL;
      dispatch({ type, payload: response });
    });
  };
};
  ...
  return (dispatch) => {
    ...
    callApiToken(dispatch, "rates/replies", "DELETE", data).then((response) => {
      ...
      if (response.status === 0) {
        ...
        response.data = data;
      } else type = Types.RATE_REPLY_DELETE_FAIL;
      dispatch({ type, payload: response });
    });
  };
};
